...
import MambaCD.changedetection.comparison_models.resnet as models
from MambaCD.changedetection.comparison_models.help_funcs import Transformer, TransformerDecoder, TwoLayerConv2d
    ...
    def __init__(self, input_nc, output_nc,
        ...
        if backbone == 'resnet18':
            self.resnet = models.resnet18(pretrained=False,
                                          replace_stride_with_dilation=[False,True,True], input_nc=input_nc)
