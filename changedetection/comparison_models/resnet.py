...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,input_nc=3,
        ...
        self.conv1 = nn.Conv2d(15, self.inplanes, kernel_size=7, stride=self.strides[0], padding=3,
                               bias=False)
