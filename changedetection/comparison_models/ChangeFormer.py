...
import warnings
from MambaCD.changedetection.comparison_models.ChangeFormerBaseNetworks import *
...
from MambaCD.changedetection.comparison_models.pixel_shuffel_up import PS_UP
...
class ChangeFormerV4(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False):
        ...
        self.embedding_dim = 224

        self.Tenc_x2    = EncoderTransformer_x2(img_size=224, patch_size=3, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
        ...
        self.TDec_x2   = DecoderTransformer_x2(input_transform='multiple_select', in_index=[0, 1, 2, 3, 4], align_corners=True, 
                    in_channels = self.embed_dims, embedding_dim= 224, output_nc=output_nc, 
...
class ChangeFormerV5(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=2, decoder_softmax=False, embed_dim=224):
        ...
        self.Tenc_x2    = EncoderTransformer_v3(img_size=224, patch_size = 7, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
