...
class CGNet(nn.Module):
    def __init__(self,):
        ...
        self.decoder_final = nn.Sequential(BasicConv2d(128,64,3,1,1),nn.Conv2d(64,2,1))
...
class VGG16(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(15, 64, kernel_size=3, padding=1), # Block 1
            nn.BatchNorm2d(64),            
            ...
            nn.Conv2d(64, 128, kernel_size=3, padding=1),  # Block 2
            nn.BatchNorm2d(128),            
            nn.ReLU(inplace=True),
            ...
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            nn.Conv2d(128, 256, kernel_size=3, padding=1), # Block 3
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            ...
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            nn.Conv2d(256, 512, kernel_size=3, padding=1), # Block 4
            nn.BatchNorm2d(512),            
            nn.ReLU(inplace=True),
            ...
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),            
            nn.Conv2d(512, 512, kernel_size=3, padding=1), # Block 5
            nn.BatchNorm2d(512),
            nn.ReLU(inplace=True),
            nn.Conv2d(512, 512, kernel_size=3, padding=1),
            nn.BatchNorm2d(512),
